...
namespace Vezeeta.Infrastructure.Migrations
{
    ...
    [Migration("20231210012011_UpdateAppointmentsTablesConstraints")]
    partial class UpdateAppointmentsTablesConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vezeeta.Domain.Entities.AppointmentsDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentsDays");
                });

            modelBuilder.Entity("Vezeeta.Domain.Entities.AppointmentsHour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AppointmentsDayId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppointmentsDayId");

                    b.HasIndex("Hour", "AppointmentsDayId")
                        .IsUnique();

                    b.ToTable("AppointmentsHours");
                });
            ...
            modelBuilder.Entity("Vezeeta.Domain.Entities.AppointmentsHour", b =>
                {
                    b.HasOne("Vezeeta.Domain.Entities.AppointmentsDay", "AppointmentsDay")
                        .WithMany("ApointmentsHours")
                        .HasForeignKey("AppointmentsDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppointmentsDay");
                });
            ...
            modelBuilder.Entity("Vezeeta.Domain.Entities.Reservation", b =>
                {
                    b.HasOne("Vezeeta.Domain.Entities.AppointmentsHour", "AppointmentsHour")
                        .WithMany("Reservations")
                        .HasForeignKey("AppointmentsHourId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppointmentsHour");
                });

            modelBuilder.Entity("Vezeeta.Domain.Entities.AppointmentsDay", b =>
                {
                    b.Navigation("ApointmentsHours");
                });
